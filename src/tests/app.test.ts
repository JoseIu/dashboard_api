...
//     const expectedBookings = await Booking.find();
//     const response = await request(app).get('/bookings').set('Authorization', `Bearer ${token}`);

//     expect(response.body).toMatchObject({
//       error: false,
//       data: expectedBookings
//     });
//   });
//   test('Should response with a booking searched by ID', async () => {
//     const expectedBooking = await Booking.findOne({ 'guest.reservationID': '664b241e4e73a05972970a7c' });
//     const response = await request(app)
//       .get('/booking/664b241e4e73a05972970a7c')
...
//     const response = await request(app)
//       .get('/booking/664b241e4e73a05972970a77')
//       .set('Authorization', `Bearer ${token}`);
